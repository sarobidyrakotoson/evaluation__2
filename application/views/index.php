        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="<?php echo img_loader('banner_img_01','jpg'); ?>" alt="">
                        </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="<?php echo img_loader('banner_img_02','jpg'); ?>" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="<?php echo img_loader('banner_img_03','jpg'); ?>" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
            ...
            <?php for($i = 0;$i<3;$i++){ ?>
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="<?php echo site_url('Welcome/acheter_un'); ?>">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo site_url('Welcome/acheter_un'); ?>" class="h2 text-decoration-none text-dark"><?php echo $produit[$i]['nom']; ?></a>
                            <p class="card-text">
